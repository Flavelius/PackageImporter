...
class SBSunlight extends Light
    native
    dependsOn(LevelInfo)
  ;

  var (SBSunlight) bool ProjectShadow;
  var (SBSunlight) int FOV;
  var (SBSunlight) int MaxTraceDistance;
  var (SBSunlight) byte BlendingOp;
  var (Advanced) SBProjector AttachedSBProjector;
  var const int ProjWidth;
  var const int ProjHeight;
