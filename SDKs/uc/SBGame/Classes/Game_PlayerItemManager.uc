//==============================================================================
//  Game_PlayerItemManager
//==============================================================================

class Game_PlayerItemManager extends Game_ItemManager within Game_Pawn
    native
    dependsOn(Class,SBDBSync)
  ;

  enum EItemAddRemoveType {
    IART_Shop ,
    IART_Quest ,
    IART_Cheat ,
    IART_Breakdown 
  ...
  var int mCharacterID;
  var private array<Game_ItemContainerListener> mItemContainerListeners;
  var (null);
  var private transient int mDBAddItems;
  var private transient int mDBRemoveItems;
  var private transient int mDBAddItemCost;
  var private transient int mDBRemoveItemCost;
  ...
  function cl_OnInit() {
    ...
    Init();                                                                     //0006 : 1C E0 4F 26 11 16 
    //1C E0 C4 19 11 16 1C E0 4F 26 11 16 04 0B 47 
  }
