...
class EV_SetHealth extends Content_Event
    native
    collapsecategories
    editinlinenew
  ...
  var (Action) const byte HealthMode;
  var (Action) const float HealthValue;
  ...
  function sv_Execute(Game_Pawn aObject,Game_Pawn aSubject) {
    ...
    //05 01 01 98 09 00 14 0A 23 00 24 00 19 00 10 0A 00 14 0B 00 00 1B AC 0F 00 00 01 88 0A 00 14 16 
    //06 AB 00 0A 3F 00 24 01 19 00 10 0A 00 14 0B 00 00 1B 31 10 00 00 01 88 0A 00 14 16 06 AB 00 0A 
    //7B 00 24 02 19 00 10 0A 00 14 2B 00 00 1B AC 0F 00 00 AB 01 88 0A 00 14 39 3F 36 D8 91 18 11 19 
    //19 00 10 0A 00 14 05 00 04 01 08 43 34 0F 05 00 68 01 78 2D 34 0F 16 16 06 AB 00 0A A8 00 24 03 
    //19 00 10 0A 00 14 1C 00 00 1B AC 0F 00 00 AB 01 88 0A 00 14 19 00 10 0A 00 14 06 00 04 1B 12 10 
    //00 00 16 16 16 06 AB 00 0A FF FF 04 0B 47 
  }


  function bool sv_CanExecute(Game_Pawn aObject,Game_Pawn aSubject) {
    return aSubject != None;                                                    //0000 : 04 77 00 B0 0B 00 14 2A 16 
    //04 77 00 B0 0B 00 14 2A 16 04 0B 47 
  }
